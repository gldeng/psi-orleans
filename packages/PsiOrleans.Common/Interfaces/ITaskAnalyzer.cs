...
public interface ITaskAnalyzer
{
    ...
    Task<TaskAnalysisResult> AnalyzeTaskAsync(string taskDescription, IAgentContext context);
    ...
    Task<IEnumerable<string>> BreakdownTaskAsync(string taskDescription, IAgentContext context);
} 